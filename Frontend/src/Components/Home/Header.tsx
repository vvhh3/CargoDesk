    ...
    return (
        <div className="flex justify-between items-center px-30 py-7 bg-black border-b border-white/10">
            <div className="flex gap-3 items-center">
                <div className="flex justify-center items-center rounded-xl w-10 h-10 bg-gradient-to-br from-[#7C3AED] to-[#3B82F6]">
            ...
            <div className= "flex text-gray-400 gap-6 items-center text-base">
                ...
                <button className="w-28 h-13 text-white rounded-2xl bg-gradient-to-br from-[#7C3AED] to-[#3B82F6] duration-300 hover:scale-102 cursor-pointer">
                    Get Started
                </button>
            </div>
        </div>
