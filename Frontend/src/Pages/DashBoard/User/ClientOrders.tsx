            ...
            <table className="w-full">
              <thead className="bg-white/5 border-b border-white/10">
                <tr>
                  ...
                  <th className="text-left p-4 text-sm font-medium text-zinc-400">Payment</th>
              ...
              <tbody>
                {orders.map((order, i) => (
                  <tr key={i} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                    ...
                    <td className="p-4 text-sm text-white">{order.client}</td>
                    <td className="p-4 text-sm text-white">{order.product}</td>
                    <td className="p-4">
                      {/* <span className={`inline-flex px-3 py-1 rounded-lg text-xs font-medium ${statusStyles[order.status]}`}>
                        {order.status}
                      </span> */}
                    </td>
                    <td className="p-4">
                      {/* <span className={`inline-flex px-3 py-1 rounded-lg text-xs font-medium ${paymentStyles[order.payment]}`}>
                        {order.payment}
                      </span> */}
                    </td>
